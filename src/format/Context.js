 ...
 */
anychart.anychart['format']['Context'] = function(opt_values, opt_dataSource, opt_statisticsSources) {
  anychart.anychart['format']['Context'].base(this, 'constructor', opt_values, opt_dataSource, opt_statisticsSources);
};
goog.inherits(anychart.anychart['format']['Context'], anychart.core.BaseContext);
 ...
 * @extends {anychart.core.BaseContext}
 */
anychart.format.Context = anychart.anychart['format']['Context'];
