...
anychart.ui.RangeSelector.prototype.createDomInternal_ = function() {
  ...
  this.zoomLabel_ = goog.dom.createDom(
      ...
      anychart.anychart['format']['getMessage'](this.zoomLabelText_));
...
anychart.ui.RangeSelector.prototype.zoomLabelText = function(opt_value) {
  if (goog.isDef(opt_value)) {
    if (this.zoomLabelText_ != opt_value) {
      ...
      if (this.zoomLabel_)
        goog.dom.setTextContent(this.zoomLabel_, anychart.anychart['format']['getMessage'](this.zoomLabelText_));
    }
    return this;
  }
...
anychart.ui.RangeSelector.prototype.handleButtonAction_ = function(e) {
  ...
  if (type == anychart.enums.StockRangeType.UNIT) {
    ...
    var fromParsed = anychart.anychart['format']['parseDateTime'](descriptor['startDate']);
    var toParsed = anychart.anychart['format']['parseDateTime'](descriptor['endDate']);
